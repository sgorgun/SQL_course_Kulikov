...
SET DEFINE OFF;
Insert into "exploration"."cities" ("ct_id","ct_name") values (1,'Лондон');
Insert into "exploration"."cities" ("ct_id","ct_name") values (2,'Париж');
Insert into "exploration"."cities" ("ct_id","ct_name") values (3,'Мадрид');
Insert into "exploration"."cities" ("ct_id","ct_name") values (4,'Токио');
Insert into "exploration"."cities" ("ct_id","ct_name") values (5,'Москва');
Insert into "exploration"."cities" ("ct_id","ct_name") values (6,'Киев');
Insert into "exploration"."cities" ("ct_id","ct_name") values (7,'Минск');
Insert into "exploration"."cities" ("ct_id","ct_name") values (8,'Рига');
Insert into "exploration"."cities" ("ct_id","ct_name") values (9,'Варшава');
Insert into "exploration"."cities" ("ct_id","ct_name") values (10,'Берлин');
REM INSERTING into "exploration"."computers"
SET DEFINE OFF;
Insert into "exploration"."computers" ("c_id","c_room","c_name") values (9,1,'Компьютер A в комнате 1');
Insert into "exploration"."computers" ("c_id","c_room","c_name") values (10,1,'Компьютер B в комнате 1');
Insert into "exploration"."computers" ("c_id","c_room","c_name") values (11,2,'Компьютер A в комнате 2');
Insert into "exploration"."computers" ("c_id","c_room","c_name") values (12,2,'Компьютер B в комнате 2');
Insert into "exploration"."computers" ("c_id","c_room","c_name") values (13,2,'Компьютер C в комнате 2');
Insert into "exploration"."computers" ("c_id","c_room","c_name") values (14,null,'Свободный компьютер A');
Insert into "exploration"."computers" ("c_id","c_room","c_name") values (15,null,'Свободный компьютер B');
Insert into "exploration"."computers" ("c_id","c_room","c_name") values (16,null,'Свободный компьютер C');
...
SET DEFINE OFF;
Insert into "exploration"."library_in_json" ("lij_id","lij_book","lij_author","lij_genre") values (1,'Евгений Онегин','[{"id":7,"name":"А.С. Пушкин"}]','[{"id":1,"name":"Поэзия"},{"id":5,"name":"Классика"}]');
Insert into "exploration"."library_in_json" ("lij_id","lij_book","lij_author","lij_genre") values (2,'Сказка о рыбаке и рыбке','[{"id":7,"name":"А.С. Пушкин"}]','[{"id":1,"name":"Поэзия"},{"id":5,"name":"Классика"}]');
Insert into "exploration"."library_in_json" ("lij_id","lij_book","lij_author","lij_genre") values (3,'Основание и империя','[{"id":2,"name":"А. Азимов"}]','[{"id":6,"name":"Фантастика"}]');
Insert into "exploration"."library_in_json" ("lij_id","lij_book","lij_author","lij_genre") values (4,'Психология программирования','[{"id":3,"name":"Д. Карнеги"},
                 {"id":6,"name":"Б. Страуструп"}]','[{"id":2,"name":"Программирование"},
                 {"id":3,"name":"Психология"}]');
Insert into "exploration"."library_in_json" ("lij_id","lij_book","lij_author","lij_genre") values (5,'Язык программирования С++','[{"id":6,"name":"Б. Страуструп"}]','[{"id":2,"name":"Программирование"}]');
Insert into "exploration"."library_in_json" ("lij_id","lij_book","lij_author","lij_genre") values (6,'Курс теоретической физики','[{"id":4,"name":"Л.Д. Ландау"},
                 {"id":5,"name":"Е.М. Лифшиц"}]','[{"id":5,"name":"Классика"}]');
Insert into "exploration"."library_in_json" ("lij_id","lij_book","lij_author","lij_genre") values (7,'Искусство программирования','[{"id":1,"name":"Д. Кнут"}]','[{"id":2,"name":"Программирование"},
                 {"id":5,"name":"Классика"}]');
REM INSERTING into "exploration"."overflow"
SET DEFINE OFF;
REM INSERTING into "exploration"."rooms"
SET DEFINE OFF;
Insert into "exploration"."rooms" ("r_id","r_name","r_space") values (1,'Комната с двумя компьютерами',5);
Insert into "exploration"."rooms" ("r_id","r_name","r_space") values (2,'Комната с тремя компьютерами',5);
Insert into "exploration"."rooms" ("r_id","r_name","r_space") values (3,'Пустая комната 1',2);
Insert into "exploration"."rooms" ("r_id","r_name","r_space") values (4,'Пустая комната 2',2);
Insert into "exploration"."rooms" ("r_id","r_name","r_space") values (5,'Пустая комната 3',2);
REM INSERTING into "exploration"."shopping"
SET DEFINE OFF;
Insert into "exploration"."shopping" ("sh_id","sh_transaction","sh_category") values (1,1,'Сумка');
Insert into "exploration"."shopping" ("sh_id","sh_transaction","sh_category") values (2,1,'Платье');
Insert into "exploration"."shopping" ("sh_id","sh_transaction","sh_category") values (3,1,'Сумка');
Insert into "exploration"."shopping" ("sh_id","sh_transaction","sh_category") values (4,2,'Сумка');
Insert into "exploration"."shopping" ("sh_id","sh_transaction","sh_category") values (5,2,'Юбка');
Insert into "exploration"."shopping" ("sh_id","sh_transaction","sh_category") values (6,3,'Платье');
Insert into "exploration"."shopping" ("sh_id","sh_transaction","sh_category") values (7,3,'Юбка');
Insert into "exploration"."shopping" ("sh_id","sh_transaction","sh_category") values (8,3,'Туфли');
Insert into "exploration"."shopping" ("sh_id","sh_transaction","sh_category") values (9,3,'Шляпка');
Insert into "exploration"."shopping" ("sh_id","sh_transaction","sh_category") values (10,4,'Сумка');
REM INSERTING into "exploration"."site_pages"
SET DEFINE OFF;
Insert into "exploration"."site_pages" ("sp_id","sp_parent","sp_name") values (1,null,'Главная');
Insert into "exploration"."site_pages" ("sp_id","sp_parent","sp_name") values (2,1,'Читателям');
Insert into "exploration"."site_pages" ("sp_id","sp_parent","sp_name") values (3,1,'Спонсорам');
Insert into "exploration"."site_pages" ("sp_id","sp_parent","sp_name") values (4,1,'Рекламодателям');
Insert into "exploration"."site_pages" ("sp_id","sp_parent","sp_name") values (5,2,'Новости');
Insert into "exploration"."site_pages" ("sp_id","sp_parent","sp_name") values (6,2,'Статистика');
Insert into "exploration"."site_pages" ("sp_id","sp_parent","sp_name") values (7,3,'Предложения');
Insert into "exploration"."site_pages" ("sp_id","sp_parent","sp_name") values (8,3,'Истории успеха');
Insert into "exploration"."site_pages" ("sp_id","sp_parent","sp_name") values (9,4,'Акции');
Insert into "exploration"."site_pages" ("sp_id","sp_parent","sp_name") values (10,1,'Контакты');
Insert into "exploration"."site_pages" ("sp_id","sp_parent","sp_name") values (11,3,'Документы');
Insert into "exploration"."site_pages" ("sp_id","sp_parent","sp_name") values (12,6,'Текущая');
Insert into "exploration"."site_pages" ("sp_id","sp_parent","sp_name") values (13,6,'Архивная');
Insert into "exploration"."site_pages" ("sp_id","sp_parent","sp_name") values (14,6,'Неофициальная');
