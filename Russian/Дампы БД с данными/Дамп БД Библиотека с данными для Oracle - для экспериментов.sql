...
SET DEFINE OFF;
Insert into "library_exp"."authors" ("a_id","a_name") values (1,'Д. Кнут');
Insert into "library_exp"."authors" ("a_id","a_name") values (2,'А. Азимов');
Insert into "library_exp"."authors" ("a_id","a_name") values (3,'Д. Карнеги');
Insert into "library_exp"."authors" ("a_id","a_name") values (4,'Л.Д. Ландау');
Insert into "library_exp"."authors" ("a_id","a_name") values (5,'Е.М. Лифшиц');
Insert into "library_exp"."authors" ("a_id","a_name") values (6,'Б. Страуструп');
Insert into "library_exp"."authors" ("a_id","a_name") values (7,'А.С. Пушкин');
REM INSERTING into "library_exp"."books"
SET DEFINE OFF;
Insert into "library_exp"."books" ("b_id","b_name","b_year","b_quantity") values (1,'Евгений Онегин',1985,2);
Insert into "library_exp"."books" ("b_id","b_name","b_year","b_quantity") values (2,'Сказка о рыбаке и рыбке',1990,3);
Insert into "library_exp"."books" ("b_id","b_name","b_year","b_quantity") values (3,'Основание и империя',2000,5);
Insert into "library_exp"."books" ("b_id","b_name","b_year","b_quantity") values (4,'Психология программирования',1998,1);
Insert into "library_exp"."books" ("b_id","b_name","b_year","b_quantity") values (5,'Язык программирования С++',1996,3);
Insert into "library_exp"."books" ("b_id","b_name","b_year","b_quantity") values (6,'Курс теоретической физики',1981,12);
Insert into "library_exp"."books" ("b_id","b_name","b_year","b_quantity") values (7,'Искусство программирования',1993,7);
REM INSERTING into "library_exp"."genres"
SET DEFINE OFF;
Insert into "library_exp"."genres" ("g_id","g_name") values (1,'Классика');
Insert into "library_exp"."genres" ("g_id","g_name") values (2,'Наука');
Insert into "library_exp"."genres" ("g_id","g_name") values (3,'Поэзия');
Insert into "library_exp"."genres" ("g_id","g_name") values (4,'Программирование');
Insert into "library_exp"."genres" ("g_id","g_name") values (5,'Психология');
Insert into "library_exp"."genres" ("g_id","g_name") values (6,'Фантастика');
...
SET DEFINE OFF;
Insert into "library_exp"."subscribers" ("s_id","s_name") values (1,'Иванов И.И.');
Insert into "library_exp"."subscribers" ("s_id","s_name") values (2,'Петров П.П.');
Insert into "library_exp"."subscribers" ("s_id","s_name") values (3,'Сидоров С.С.');
Insert into "library_exp"."subscribers" ("s_id","s_name") values (4,'Сидоров С.С.');
